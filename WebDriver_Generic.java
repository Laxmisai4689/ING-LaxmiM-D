...
public class WebDriver_Generic {
	...
	public static void Driver_Close(WebDriver driver)
	{
		driver.close();
	}
	...
	public static void Driver_wait(WebDriver driver,int t)
	{
		driver.manage().timeouts().implicitlyWait( t, TimeUnit.SECONDS);
	}
	
	public static void Driver_Explicitwait(WebDriver driver,int t)
	{
	...
	public void WebElementJSclick(WebDriver driver , WebElement ele)
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", ele);
	}
	
	public void WebElementJSscrollIntoView(WebDriver driver , WebElement ele)
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
